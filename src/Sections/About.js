    ...
    return (
        <div className="container font-pridi" id="about">
            <div className="row d-flex justify-content-center justify-content-lg-between">
                ...
                <div className="col-sm-12 col-lg-6 my-5 my-lg-auto">
                    <h4 className="text-justify text-md-justify font-weight-normal">
                        ...
                        las  experiencia de las personas y su relación con su entorno visual y digital.
                        <br /><br />
                        Me apasiona construir puentes entre las personas, el diseño y la tecnología.
                        <br /><br />
                    </h4>
                    <h5>
                        Los lenguajes, software y técnologías que conozco:
                    </h5>
            ...
            <div className="row my-5">
                <div className="col-12">
                    ...
                    <div className="d-flex flex-column flex-md-row justify-content-center my-5">
                        <a href="https://www.linkedin.com/in/ierrandonea" class="btn btn-outline-dark rounded-sm btn-lg mx-5 mx-md-3 mx-lg-5 mt-3 d-flex align-items-center" target="_blank">Conectar en<i class="fab fa-linkedin fa-2x ml-2"></i></a>
                        <a href="/static/misc/resumen-inaki-errandonea.pdf" class="btn btn-outline-dark rounded-sm btn-lg mx-5 mx-md-3 mx-lg-5 mt-3 d-flex align-items-center" target="_blank">Descargar mi CV<i class="fas fa-file-pdf fa-2x ml-2"></i></a>
                        <a href="https://github.com/ierrandonea" class="btn btn-outline-dark rounded-sm btn-lg mx-5 mx-md-3 mx-lg-5 mt-3 d-flex align-items-center" target="_blank">Visitar mi<i class="fab fa-github-square fa-2x ml-2"></i></a>
                    </div>
                </div>
            </div>
